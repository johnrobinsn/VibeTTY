...
fun EulaScreen(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                Text(
                    text = "Copyright © 2026 John Robinson",
            ...
            item {
                Text(
                    text = "Copyright © Kenny Root\n\nConnectBot is a simple, powerful, open-source SSH client for Android, also licensed under the Apache License, Version 2.0.",
                    style = MaterialTheme.typography.bodyMedium,
